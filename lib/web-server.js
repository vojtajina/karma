...
exports.createWebServer = function (baseFolder, proxies, urlRoot,
  ...
  var spdyOpts = {
    key: fs.readFileSync(__dirname + '/../karma.key'),
    cert: fs.readFileSync(__dirname + '/../karma.crt'),
    ca: fs.readFileSync(__dirname + '/../karma.csr'),
  ...
  var server = spdy.createServer(spdyOpts, createHandler(promiseContainer,
